...
UPDATE events SET page = 'anish' WHERE page IS NULL;
INSERT OR REPLACE INTO users (username, display, salt, hash, iterations, created, page, disabled)
VALUES ('anish', 'anish', 'WGfGtdUwzFhI8QOn+F90AA==', 'E81/pQOG3T5if67sC+XIL+vsQGfm5CRhzDCbzzjxcEk=', 100000, 1790173264023, '{"title": "My Links", "subtitle": "All my links in one place ✨", "columns": [{"name": "Earn Money", "icon": "💬", "links": [{"title": "Iphone recording", "url": "https://www.crowtado.com/sign-up?ref=Q2RLTGX9"}]}, {"name": "Books", "icon": "📗", "links": [{"title": "GATE 2027 High Demanded PYQ Book", "url": "https://gatecseguide.github.io/"}]}]}', 0);
